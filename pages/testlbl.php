...
elseif(strpos($model, '10046')!== false){
    ...
    ^A0N,20,20^FO350,405^FDBom Rev.M ^FS 
...
^A0N,45,25^FO180,30^FD$model-$rev^FS 

^FO75,85^BY2^BCn,60,N^FDP$model-$rev^FS 
...
^FO70,550^BY1^BCn,60,N^FDS$box_id^FS 

^FO340,480^GB2,150,3^FS 

^A0N,20,20^FO360,500^FDDate $tmstmp^FS 
^A0N,20,20^FO360,530^FD(L) Lot #$lot^FS 

^FO360,520^GB250,2,3^FS

^FO370,560^BY2^BCn,50,N^FDT$lot^FS 

^FO10,630^GB630,2,3^FS
^XZ";
