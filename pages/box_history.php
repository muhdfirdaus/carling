                ...
                <div class="panel-body">
                    ...
                    <table class="table table-bordered table-striped">
                        <thead>
                            ...
                            <th class="info text-center">Rev</th>
                            ...
                            <th class="info text-center">Details</th>
                        </thead>
                        <tbody>
                        <?php
                        ...
                        $query2=mysqli_query($con,"select * from box_master where timestamp>=$currentdate")or die(mysqli_error($con));
                        while($data = mysqli_fetch_array($query2)){
                        ?>
                            <tr>
                                <td><?php echo $data['box_id'];?></td>
                                <td><?php echo $data['model'];?></td>
                                <td><?php echo $data['rev'];?></td>
                                <td><?php echo $data['qty'];?></td>
                                <td><?php echo $data['wo'];?></td>
                                <td><?php echo date('d-M-Y h:i:sa',$data['timestamp']);?></td>
                                <?php if($data['status']=="1"){echo "<td class='text-green'><b>FINISH</b>";}else echo "<td class='text-red'><b>ON GOING</b>";?></td>
                                <td><a href="boxdetails.php?boxid=<?php echo $data['box_id'];?>" target="_blank" style="color:#fff;" class="small-box-footer"><i class="glyphicon glyphicon-edit text-blue"></i></a></td>
                            </tr> 
                        <?php } ?>   
                        </tbody>
                    </table>
